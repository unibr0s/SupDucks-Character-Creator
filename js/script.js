...
// Select buttons and traits
const buttons = document.querySelectorAll('#randomize, #export, .tab-button');
const traits = document.querySelectorAll('.trait-option');

// Hover Sound: Add hover event listeners
buttons.forEach(button => {
    button.addEventListener('mouseenter', () => {
        playHoverSound();
        console.log('Hover sound triggered on button:', button);
    });
});
...
traits.forEach(trait => {
    trait.addEventListener('mouseenter', () => {
        playHoverSound();
        console.log('Hover sound triggered on trait:', trait);
    });
});

// Shrink Animation: Add press effect to buttons
document.addEventListener('DOMContentLoaded', () => {
    const buttonsToShrink = document.querySelectorAll('#randomize, #export, .tab-button');

    buttonsToShrink.forEach(button => {
        button.addEventListener('mousedown', () => {
            console.log('Button pressed (mousedown):', button);
            button.classList.add('shrink');
        });

        button.addEventListener('mouseup', () => {
            console.log('Button released (mouseup):', button);
